    ...
    <ViewDiv className="w-full">
      ...
      >
        <ViewDiv className="flex flex-col max-w-md w-full gap-y-24">
          ...
          >
            <TextDiv className="text-[#62565A] text-base max-w-md w-full font-medium">
              Hello {user ?? "Adenike"},{" "}
            </TextDiv>
            <ViewDiv className="text-lg max-w-md w-full flex-col">
              ...
              >
                {(visible && phase) ?? "Ovulatory Phase."}
              </TextDiv>
              <TextDiv className="text-[#62565A] text-sm max-w-md w-[65%] mt-2">
